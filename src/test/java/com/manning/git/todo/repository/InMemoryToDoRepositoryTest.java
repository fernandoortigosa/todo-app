...
public class InMemoryToDoRepositoryTest {
    ...
    public void testDeleteToDoItem() {
        ...
        ToDoItem insertedItem = inMemoryToDoRepository.findById(newId);
        assertNotNull(insertedItem);

        inMemoryToDoRepository.delete(newToDoItem);
        ToDoItem deletedItem = inMemoryToDoRepository.findById(newId);
